...
<li class="breadcrumb-item active">Sertifika&Ödül Düzenle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-fw fa-trophy"></i> Sertifika&Ödül Düzenle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/sertifikalarim/duzenle/update/$sertifikalarim->id"); ?>" method="post">
<input type="hidden" name="yazar_id" value="<?php $user = $this->session->userdata("user"); echo $user["id"]; ?>">
<div class="form-group">
<label for="sertifika_adi">Sertifika&Ödül Adı</label>
<input type="text" class="form-control" id="sertifika_adi" name="sertifika_adi" value="<?php echo $sertifikalarim->sertifika_adi; ?>">
</div>
<div class="form-group">
<label for="sertifika_durum">Onaylı mı?</label>
<select class="form-control" id="sertifika_durum" name="sertifika_durum">
<option value="1" <?php if($sertifikalarim->sertifika_durum=="1"){echo "selected";}; ?>>Onaylı</option>
<option value="0" <?php if($sertifikalarim->sertifika_durum=="0"){echo "selected";}; ?>>Onaysız</option>
</select>
</div>
<div class="form-group">
