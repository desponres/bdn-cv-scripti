...
<i class="fa fa-fw fa-certificate"></i> Yetenek Ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/yeteneklerim/ekle/insert"); ?>" method="post">
...
<input type="text" class="form-control" id="yetenek_yuzde" name="yetenek_yuzde">
</div>
<div class="form-group">
