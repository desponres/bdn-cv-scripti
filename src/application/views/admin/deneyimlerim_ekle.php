...
<li class="breadcrumb-item active">Deneyim Ekle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-fw fa-star"></i> Deneyim Ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/deneyimlerim/ekle/insert"); ?>" method="post">
...
<input type="text" class="form-control" id="dny_adi" name="dny_adi">
</div>
<div class="form-group">
<label for="dny_firma_adi">Firma Adı</label>
<input type="text" class="form-control" id="dny_firma_adi" name="dny_firma_adi">
</div>
<div class="form-group">
<label for="dny_calisma_tarihleri">Çalışma Tarihleri</label>
<input type="text" class="form-control" id="dny_calisma_tarihleri" name="dny_calisma_tarihleri">
</div>
<div class="form-group">
<label for="dny_aciklama">Açıklama</label>
<textarea class="form-control" id="dny_aciklama" name="dny_aciklama" rows="5"></textarea>
</div>
<div class="form-group">
