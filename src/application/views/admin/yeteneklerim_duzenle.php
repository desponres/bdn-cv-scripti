...
<li class="breadcrumb-item active">Yetenek Düzenle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-fw fa-certificate"></i> Yetenek Düzenle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/yeteneklerim/duzenle/update/$yeteneklerim->id"); ?>" method="post">
<input type="hidden" name="yazar_id" value="<?php $user = $this->session->userdata("user"); echo $user["id"]; ?>">
<div class="form-group">
<label for="yetenek_baslik">Yetenek Adı</label>
<input type="text" class="form-control" id="yetenek_baslik" name="yetenek_baslik" value="<?php echo $yeteneklerim->yetenek_baslik; ?>">
</div>
<div class="form-group">
<label for="yetenek_yuzde">Yetenek Yüzdesi</label>
<input type="text" class="form-control" id="yetenek_yuzde" name="yetenek_yuzde" value="<?php echo $yeteneklerim->yetenek_yuzde; ?>">
</div>
<div class="form-group">
<label for="yetenek_durum">Onaylı mı?</label>
<select class="form-control" id="yetenek_durum" name="yetenek_durum">
<option value="1" <?php if($yeteneklerim->yetenek_durum=="1"){echo "selected";}; ?>>Onaylı</option>
<option value="0" <?php if($yeteneklerim->yetenek_durum=="0"){echo "selected";}; ?>>Onaysız</option>
</select>
</div>
<div class="form-group">
