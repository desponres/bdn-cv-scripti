...
<i class="fa fa-fw fa-graduation-cap"></i> Eğitim Düzenle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/egitimlerim/duzenle/update/$egitimlerim->id"); ?>" method="post">
...
<input type="text" class="form-control" id="eg_okul_adi" name="eg_okul_adi" value="<?php echo $egitimlerim->eg_okul_adi; ?>">
</div>
<div class="form-group">
<label for="eg_bolum_adi">Bölüm Adı</label>
<input type="text" class="form-control" id="eg_bolum_adi" name="eg_bolum_adi" value="<?php echo $egitimlerim->eg_bolum_adi; ?>">
</div>
<div class="form-group">
<label for="eg_not_ortalamasi">Not Ortalaması</label>
<input type="text" class="form-control" id="eg_not_ortalamasi" name="eg_not_ortalamasi" value="<?php echo $egitimlerim->eg_not_ortalamasi; ?>">
</div>
<div class="form-group">
<label for="eg_tarih">Eğitim Tarihleri</label>
<input type="text" class="form-control" id="eg_tarih" name="eg_tarih" value="<?php echo $egitimlerim->eg_tarih; ?>">
</div>
<div class="form-group">
<label for="eg_bolum_icerigi">Bölüm içeriği</label>
<textarea type="text" class="form-control" id="eg_bolum_icerigi" name="eg_bolum_icerigi" rows="5"><?php echo $egitimlerim->eg_bolum_icerigi; ?></textarea>
</div>
<div class="form-group">
<label for="eg_durum">Onaylı mı?</label>
<select class="form-control" id="eg_durum" name="eg_durum">
<option value="1" <?php if($egitimlerim->eg_durum=="1"){echo "selected";}; ?>>Onaylı</option>
<option value="0" <?php if($egitimlerim->eg_durum=="0"){echo "selected";}; ?>>Onaysız</option>
</select>
</div>
<div class="form-group">
