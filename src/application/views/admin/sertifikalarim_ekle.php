...
<li class="breadcrumb-item active">Sertifika&Ödül Ekle</li>
</ol>
<div class="card mb-3">
<div class="card-header">
<i class="fa fa-fw fa-trophy"></i> Sertifika&Ödül Ekle</div>
<div class="card-body">
<form action="<?php echo base_url("admin/sertifikalarim/ekle/insert"); ?>" method="post">
...
<input type="text" class="form-control" id="sertifika_adi" name="sertifika_adi">
</div>
<div class="form-group">
